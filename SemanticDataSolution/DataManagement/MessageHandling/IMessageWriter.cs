...
namespace UAOOI.SemanticData.DataManagement.MessageHandling
{
  ...
  public interface IMessageWriter : IMessageHandler
  {
    ...
    void Send
      (Func<int, IProducerBinding> producerBinding, ushort length, ulong contentMask, ISemanticData semanticData, ushort messageSequenceNumber, DateTime timeStamp, MessageHeader.ConfigurationVersionDataType configurationVersion); //TODO semanticData => DataSetId
