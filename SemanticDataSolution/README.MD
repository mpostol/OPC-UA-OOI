...
Because any **UA Semantic Data** instance is a uniquely named standalone entity the security can be provide in context of the data but not in context of the server the data is exposed by.
