...
{
  /// <summary>
  /// Interface IIntegrationServices - An instance of this interface represents the an object providing all integration related setup functionality and runtime services.
  /// </summary>
  public interface IIntegrationServices
  {
    ...
    void AddAssociation(IAssociation association, string name);
    /// <summary>
