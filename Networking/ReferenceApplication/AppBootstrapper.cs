  ...
  internal class AppBootstrapper : MefBootstrapper
  {
    ...
    protected override void OnInitialized()
    {
      try
      {
        ...
        Consumer.ConsumerDataManagementSetup m_ConsumerConfigurationFactory = Container.GetExportedValue<Consumer.ConsumerDataManagementSetup>();
        m_ConsumerConfigurationFactory.Setup();
        m_Components.Add(m_ConsumerConfigurationFactory);
        ReferenceApplicationEventSource.Log.PartCreated(nameof(Consumer.ConsumerDataManagementSetup));
